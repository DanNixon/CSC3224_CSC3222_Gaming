...
void SnookerSimulation::gameStartup()
{
  ...
  m_table = new RenderableObject(Mesh::GenerateRect2D(Vector2(3569.0f, 1778.0f)), m_texShader, m_tableTex);
  m_table->setModelMatrix(Matrix4::Translation(Vector3(0.0, 0.0, -3600.0)));

  m_child = new RenderableObject(Mesh::GenerateRect2D(Vector2(200.0f, 100.0f)), m_colShader);
