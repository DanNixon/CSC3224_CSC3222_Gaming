...
namespace FlightSim
{
  ...
  public:
    ...
    /**
     * @param Gets the name of the terrain profile.
     * @return Profile name
     */
    ...
    /**
     * @param Gets the display name of the terrain profile.
    ...
    /**
     * @param Gets the width of the terrain geerated by this profile.
     * @return Width (m)
     */
    ...
    /**
     * @param Gets the depth of the terrain generated by this profile.
     * @return Depth (m)
     */
