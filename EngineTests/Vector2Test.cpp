...
{		
    ...
    TEST_METHOD(test_normalise)
    {
      Vector2 v(5.0f, 3.0f);
      v.normalise();
      Assert::AreEqual(0.857f, v[0], 0.001f);
      Assert::AreEqual(0.515f, v[1], 0.001f);
    }
    ...
    {
      Vector2 v(5.0f, 3.0f);
      Vector2 v2 = v.inverse();
      Assert::AreEqual(-5.0f, v2[0]);
      Assert::AreEqual(-3.0f, v2[1]);
    }
    ...
    TEST_METHOD(test_operatorPlus)
    {
      ...
      Vector2 v3 = v1 + v2;
      Assert::AreEqual(7.0f, v3[0]);
      Assert::AreEqual(4.0f, v3[1]);
    }
    ...
    TEST_METHOD(test_operatorPlusEquals)
    {
      ...
      Vector2 v2(2.0f, 1.0f);
      v1 += v2;
      Assert::AreEqual(7.0f, v1[0]);
      Assert::AreEqual(4.0f, v1[1]);
    }
    ...
    TEST_METHOD(test_operatorMinus)
    {
      ...
      Vector2 v2(2.0f, 1.0f);
      Vector2 v3 = v1 - v2;
      Assert::AreEqual(3.0f, v3[0]);
      Assert::AreEqual(2.0f, v3[1]);
    }
    ...
    TEST_METHOD(test_operatorMultVec)
    {
      ...
      Vector2 v3 = v1 * v2;
      Assert::AreEqual(10.0f, v3[0]);
      Assert::AreEqual(9.0f, v3[1]);
    }
    ...
    TEST_METHOD(test_operatorDivVec)
    {
      ...
      Vector2 v3 = v1 / v2;
      Assert::AreEqual(1.6667f, v3[0], 0.001f);
      Assert::AreEqual(2.0f, v3[1]);
    }
    ...
    TEST_METHOD(test_operatorDivFloat)
    {
      Vector2 v1(5.0f, 3.0f);
      Vector2 v3 = v1 / 2.0;
      Assert::AreEqual(2.5f, v3[0]);
      Assert::AreEqual(1.5f, v3[1]);
    }
