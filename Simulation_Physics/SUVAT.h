...
public:
  ...
  static Engine::Maths::Vector3 getVfromUAT(const Engine::Maths::Vector3 &u, const Engine::Maths::Vector3 &a, float &t);
  static Engine::Maths::Vector3 getSfromUAT(const Engine::Maths::Vector3 &u, const Engine::Maths::Vector3 &a, float &t);
  static Engine::Maths::Vector3 getSfromUVT(const Engine::Maths::Vector3 &u, const Engine::Maths::Vector3 &v, float &t);
