...
public:
  ...
  inline Vector3 operator*(const Vector3 &v) const
  {
    ...
    vec.m_x = v.m_x * m_values[0] + v.m_y * m_values[4] + v.m_z * m_values[8] +
              m_values[12];
    vec.m_y = v.m_x * m_values[1] + v.m_y * m_values[5] + v.m_z * m_values[9] +
              m_values[13];
    vec.m_z = v.m_x * m_values[2] + v.m_y * m_values[6] + v.m_z * m_values[10] +
              m_values[14];
